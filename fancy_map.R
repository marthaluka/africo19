...
plotFunction<-function(selection, na.rm=T) {
  ...
  ggplot() + 
    ...
    geom_line(data=plot2_data, aes(x=date, y=smoothed_cases_per_million/highestCasesInADay), 
              size=1)+
    ...
    theme(axis.title.x = element_blank(),
          axis.title.y = element_text(color="black", size=3),
...
maps_2 <- ggdraw(xlim = c(2, 58), ylim = c(15,45)) +
  ...
  geom_polygon(aes(x = c(31.5,35,35), y = c(34.5, 32, 34.5)),
  ...
  geom_polygon(aes(x = c(30.5,35,35), y = c(35.5, 29.5, 31.5)),
               fill = "#D95F02", alpha = 0.6) +
  draw_plot(Belgium, x = 35, y = 29, width = 3.5, height = 2.5) +     #Belgium
  geom_polygon(aes(x = c(30.6,25,25), y = c(35.8, 34, 35)),
  ...
  geom_polygon(aes(x = c(31.2,31,32.5), y = c(35, 32, 32)),
             fill = "#666666", alpha = 0.6) +
  draw_plot(Switzerland, x = 31, y = 29.5, width = 3.5, height = 2.5)        #Switzerland


  geom_polygon(aes(x = c(32,34.2,34.2), y = c(34.4, 32, 33.3)),
               fill = "#A6CEE3", alpha = 0.6) +
  draw_plot(United_Kingdom, x = 34, y = 30.5, width = 3.5, height = 2.5) +         #United Kingdom
  geom_polygon(aes(c(51,50,53), y = c(33.5, 35, 35)),
               fill = "#1F78B4", alpha = 0.6) +
  draw_plot(United_States, x = 49, y = 35, width = 3.5, height = 2.5)       #United States


    
pdf(paste0("./figures/map2_trial.pdf"), width=22, height = 13)
maps_2
dev.off()
